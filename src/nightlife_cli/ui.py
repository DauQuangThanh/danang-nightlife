"""UI components and interactive elements for Nightlife CLI."""
...
app = typer.Typer(
    name="nightlife",
    help="Setup tool for Nightlife spec-driven development projects",
...
def callback(ctx: typer.Context):
    ...
    if ctx.invoked_subcommand is None and "--help" not in sys.argv and "-h" not in sys.argv:
        show_banner()
        console.print(Align.center("[dim]Run 'nightlife --help' for usage information[/dim]"))
        console.print()
