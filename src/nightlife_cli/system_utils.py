"""System utilities and command execution for Nightlife CLI."""
...
def check_tool(tool: str, tracker: "StepTracker" = None) -> bool:
    ...
    # See: https://github.com/dauquangthanh/danang-nightlife/issues/123
...
def init_git_repo(project_path: Path, quiet: bool = False) -> Tuple[bool, Optional[str]]:
    ...
    try:
        ...
        subprocess.run(["git", "commit", "-m", "Initial commit from Nightlife template"], check=True, capture_output=True, text=True)
        if not quiet:
