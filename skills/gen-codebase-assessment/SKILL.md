...
```bash
bash <SKILL_DIR>/scripts/setup-context-assessment.sh --json
```

**Windows PowerShell**:

```powershell
.\<SKILL_DIR>\scripts\setup-context-assessment.ps1 -Json
```
...
```bash
bash <SKILL_DIR>/scripts/update-agent-context.sh [agent-type]
```

**Windows PowerShell**:

```powershell
.\<SKILL_DIR>\scripts\update-agent-context.ps1 [-AgentType agent-type]
```
...
Sets up context assessment environment:

```bash
bash <SKILL_DIR>/scripts/setup-context-assessment.sh --json          # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\setup-context-assessment.ps1 -Json             # Windows PowerShell
```
...
bash <SKILL_DIR>/scripts/update-agent-context.sh claude              # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\update-agent-context.ps1 -AgentType claude     # Windows PowerShell

# Update all agents
bash <SKILL_DIR>/scripts/update-agent-context.sh                     # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\update-agent-context.ps1                       # Windows PowerShell
```
...
- Setup Script: `<SKILL_DIR>/scripts/setup-context-assessment.sh` / `.ps1`
- Agent Update: `<SKILL_DIR>/scripts/update-agent-context.sh` / `.ps1`
