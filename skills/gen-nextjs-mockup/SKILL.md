...
```bash
bash <SKILL_DIR>/scripts/check-prerequisites.sh                  # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\check-prerequisites.ps1                    # Windows PowerShell
...
- **scripts/check-prerequisites.sh**: Bash script for macOS/Linux/WSL
- **scripts/check-prerequisites.ps1**: PowerShell script for Windows
