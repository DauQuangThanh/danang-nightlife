...
1. **Resolve Technology Stack Conflict** (ID: I1)
   ...
   - **Command:** Edit conflicting document manually
...
3. **Fix Ground-Rules Violation** (ID: G1)
   ...
   - **Command:** Edit design.md manually
...
1. **Resolve Ambiguous Requirements** (IDs: A1, A2, A3)
   ...
   - **Command:** Update spec.md to add measurable criteria
...
```
1. Fix critical issues first (manual edits to resolve conflicts and add missing tasks)
2. Refine specifications (use requirements-specification skill to resolve ambiguities)
3. Update design if needed (use technical-detailed-design skill)
4. Re-run consistency analysis to verify fixes
