---
name: gen-project-consistency-analysis
...
```bash
bash <SKILL_DIR>/scripts/check-analysis-prerequisites.sh /path/to/feature --json
```

**Windows PowerShell:**

```powershell
.\<SKILL_DIR>\scripts\check-analysis-prerequisites.ps1 -FeatureDirectory /path/to/feature -Json
```
...
**If LOW/No Issues**: Clear to proceed, optional improvements can be deferred
...
```bash
bash <SKILL_DIR>/scripts/check-analysis-prerequisites.sh /path/to/specs/feature-name --json
```

**Output:**

```json
{"success":true,"feature_dir":"/path/to/specs/feature-name","spec_file":"/path/to/specs/feature-name/spec.md","design_file":"/path/to/specs/feature-name/design.md","tasks_file":"/path/to/specs/feature-name/tasks.md","ground_rules_available":true,"architecture_available":true,"standards_available":true}
```
```
...
```bash
bash <SKILL_DIR>/scripts/check-analysis-prerequisites.sh [feature-directory] [--json]     # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\check-analysis-prerequisites.ps1 [-FeatureDirectory dir] [-Json]    # Windows PowerShell
```
...
- Checks for ground-rules.md, architecture.md, standards.md in docs/memory directories
...
- [ ] All required artifacts analyzed (spec.md, design.md, tasks.md)
