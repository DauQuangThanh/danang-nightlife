---
name: gen-project-ground-rules-setup
...
# General Project Ground Rules Setup
...
cat <SKILL_DIR>/references/ground-rules-template.md
...
1. Start with template from `<SKILL_DIR>/references/ground-rules-template.md`
...
1. **Design Template** (in `gen-technical-detailed-design` skill)
   - Ensure "Ground-rules Check" sections align with updated principles
   - Update any hardcoded rule references

2. **Specification Template** (in `gen-requirement-development` skill)
...
3. **Tasks Template** (in `gen-coding-plan` skill)
...
1. Template should be at `<SKILL_DIR>/references/ground-rules-template.md`
...
1. Verify file exists: `test -f <SKILL_DIR>/references/ground-rules-template.md`
...
- [ground-rules-template.md](references/ground-rules-template.md) - Template with placeholders and standard structure
- [additional-resources.md](references/additional-resources.md) - Related skills, versioning reference, and best practices for principles
