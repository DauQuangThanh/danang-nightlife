...
```bash
bash <SKILL_DIR>/scripts/check-nuxt-prerequisites.sh                  # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\check-nuxt-prerequisites.ps1                    # Windows PowerShell

# Or with JSON output for automation
bash <SKILL_DIR>/scripts/check-nuxt-prerequisites.sh --json           # macOS/Linux/WSL
.\<SKILL_DIR>\scripts\check-nuxt-prerequisites.ps1 -Json              # Windows PowerShell
```
...
```bash
# Check prerequisites
bash <SKILL_DIR>/scripts/check-nuxt-prerequisites.sh
...
Prerequisite check scripts (cross-platform):

- **scripts/check-nuxt-prerequisites.sh**: Bash script for macOS/Linux/WSL
