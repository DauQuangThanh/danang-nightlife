...
- Bash 4.0+ (macOS, Linux, Git Bash, WSL) or PowerShell 5.1+ (Windows) for running scripts (optional)
...
bash scripts/generate-command.sh command-name --agent claude

# PowerShell (Windows)
.\scripts\generate-command.ps1 -Name command-name -Agent claude
```
...
```bash
# Bash (macOS/Linux/WSL)
bash scripts/validate-command.sh ./path/to/command.md

# PowerShell (Windows)
.\scripts\validate-command.ps1 -Path .\path\to\command.md
```
...
```bash
# Bash (macOS/Linux/WSL)
bash scripts/validate-command.sh .claude/commands/specify.md

# PowerShell (Windows)
.\scripts\validate-command.ps1 -Path .claude\commands\specify.md
```
