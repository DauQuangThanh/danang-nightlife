...
**Note**: This template is filled in by the `/nightlife.design` command.
...
```text
specs/[###-feature]/
├── design.md            # This file (/nightlife.design command output)
├── research.md          # Phase 0 output (/nightlife.design command)
├── data-model.md        # Phase 1 output (/nightlife.design command)
├── quickstart.md        # Phase 1 output (/nightlife.design command)
├── contracts/           # Phase 1 output (/nightlife.design command)
└── tasks.md             # Phase 2 output (/nightlife.taskify command - NOT created by /nightlife.design)
```
