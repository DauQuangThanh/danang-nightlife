...
User can nightlife execution mode via arguments:
...
/nightlife.perform-e2e-test

# Run full regression suite
/nightlife.perform-e2e-test regression

# Run complete test suite
/nightlife.perform-e2e-test full

# Run specific scenarios
/nightlife.perform-e2e-test --scenarios=login,checkout,payment

# Run specific priority
/nightlife.perform-e2e-test --priority=P1

# Run with custom configuration
/nightlife.perform-e2e-test smoke --browser=firefox --retries=3 --parallel=4

# Run in headless mode
/nightlife.perform-e2e-test regression --headless

# Generate test scripts only (no execution)
/nightlife.perform-e2e-test --generate-only
```
