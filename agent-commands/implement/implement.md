...
handoffs: 
  - label: Design E2E Test Scripts
    agent: nightlife.design-e2e-test
...
Note: This command assumes a complete task breakdown exists in tasks.md. If tasks are incomplete or missing, suggest running `/nightlife.taskify` first to regenerate the task list.
